...
import { faHome, faSearch, faMusic, faPlus, faHeart } from '@fortawesome/free-solid-svg-icons'; // Import icons
import { faSpotify } from '@fortawesome/free-brands-svg-icons'; // Correct import for Spotify icon
import { NavLink } from "react-router-dom";
import Logout from './Logout';
import { faUserCircle } from '@fortawesome/free-regular-svg-icons'; // Profile icon
    ...
    <div className="home-container">
      ...
      <div className="sidebar">
        ...
        <ul>
          ...
          <li>
            <FontAwesomeIcon icon={faSearch} className="menu-icon" /> Search
          </li>
          <li>
            <FontAwesomeIcon icon={faMusic} className="menu-icon" /> Library
          </li>
          <li>
            <FontAwesomeIcon icon={faPlus} className="menu-icon" /> Create Playlist
          </li>
          <li>
            <FontAwesomeIcon icon={faHeart} className="menu-icon" /> <NavLink to="/liked-songs" className="nav-link">
           Liked Songs
            </NavLink>

          </li>
          {/* Add the Logout component here */}
          <Logout />
          {/* Add Profile Icon in Sidebar */}
        <li>
